                ...
                <ul class="list_input">
                    ...
                    <li class="btns fr">
                        <template v-if="canQuery">
                            <button class="btn btn_violet" type="button" @click="searchPupillometryData">검색</button>
                                ...
                                <table class="tb_head">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th rowspan="2" class="sticky">동공측정</th>
                                    ...
                                    <tbody>
                                        <tr v-for="(item, index) in subjects" :key="item.subjectId">
                                            ...
                                            <td><img v-if="canQueryImaging"
                                                    :src="`${getQcStatusIcon('PUPILLOMETRY', item)}`">
                                            </td>
...
const ROWS = 20;
const FUNCTION_NAME = FUNCTION_NAMES.TRIAL_DIGITALHEALTH_PUPILLOMETRY;
...
export default {
    name: "DigitalHealthPupillometry",
    props: {},
    components: {
        VueElementLoading,
        TrialDataTab,
        ...
        searchPupillometryData() {
            ...
            MemberService.getAuthMemberProjectPermission(this.projectId, FUNCTION_NAME).then(result => {
                if (result.data.succeeded) {
                    ...
                    TrialService.searchPupillometryResource(this.filters).then(result => {
                        if (result.data.succeeded) {

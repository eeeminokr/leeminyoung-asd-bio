...
import { FUNCTION_NAMES, constants, utils } from '../services/constants.js';
import FnirsResourceService from '../services/fnirsresource.service.js';
import AlertService from '../services/alert.service.js';

export default {
    name: "FnirsResourceDeleteModal",
    components: {
    ...
    methods: {
        ...
        execute() {
            ...
            try {
                ...
                FnirsResourceService.postFnirsResource(this.item['subjectId'], this.item['projectSeq'], this.item['trialIndex'])
